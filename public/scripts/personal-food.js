/* personal-food.js
for all things related to food, placing it with mouse, removing it, moving it, drawing it, colliding with it
*/
...
function placeFood(evt) {
	if( (evt.timeStamp - last_click >= FOOD_WAIT_TIME) || last_click==undefined) {		
